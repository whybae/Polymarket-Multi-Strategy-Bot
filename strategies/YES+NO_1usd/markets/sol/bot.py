"""
strategies/YES+NO_1usd/sol/bot.py
----------------------------------
...
.env variables:
  ...
  SOL_AMOUNT_TO_BUY      USDC amount per side (e.g. 1.0)
  SOL_POLL_INTERVAL      seconds between price checks (e.g. 0.5)
...
_range_raw        = os.getenv("SOL_PRICE_RANGE", "0.40-0.45")
PRICE_RANGE       = _parse_range(_range_raw)
AMOUNT_TO_BUY     = float(os.getenv("SOL_AMOUNT_TO_BUY",  "1.0"))
POLL_INTERVAL     = float(os.getenv("SOL_POLL_INTERVAL",   "0.5"))
